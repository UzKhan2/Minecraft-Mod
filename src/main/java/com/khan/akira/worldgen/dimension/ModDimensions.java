package com.khan.akira.worldgen.dimension;

import com.mojang.datafixers.util.Pair;
import com.khan.akira.akira;
import com.khan.akira.worldgen.biome.ModBiomes;
...
public class ModDimensions {
    public static final ResourceKey<LevelStem> KAUPENDIM_KEY = ResourceKey.create(Registries.LEVEL_STEM,
            new ResourceLocation(akira.MODID, "kaupendim"));
    ...
    public static final ResourceKey<DimensionType> KAUPEN_DIM_TYPE = ResourceKey.create(Registries.DIMENSION_TYPE,
            new ResourceLocation(akira.MODID, "kaupendim_type"));
