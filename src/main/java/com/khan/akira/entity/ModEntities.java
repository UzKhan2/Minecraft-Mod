package com.khan.akira.entity;

import com.khan.akira.akira;
import com.khan.akira.entity.custom.DiceProjectileEntity;
import com.khan.akira.entity.custom.ModBoatEntity;
import com.khan.akira.entity.custom.ModChestBoatEntity;
...
public class ModEntities {
        public static final DeferredRegister<EntityType<?>> ENTITY_TYPES = DeferredRegister
                        .create(ForgeRegistries.ENTITY_TYPES, akira.MODID);
        ...
        public static final RegistryObject<EntityType<DiceProjectileEntity>> DICE_PROJECTILE = ENTITY_TYPES.register(
                        "dice_projectile",
